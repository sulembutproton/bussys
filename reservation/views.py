...
def findbus(request):
    ...
    if request.method == 'POST':
        ...
        if bus_list:
            return render(request, 'reservation/list.html', locals())
        else:
            context["error"] = "Sorry no buses availiable"
            return render(request, 'reservation/findbus.html', context)
    else:
        return render(request, 'reservation/findbus.html')
    ...
    if request.method == 'POST':
        ...
        if bus:
            if bus.rem > int(seats_r):
                ...
                # book.save()
                return render(request, 'reservation/bookings.html', locals())
            else:
...
def cancellings(request):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            return render(request, 'reservation/error.html', context)
    else:
        return render(request, 'reservation/findbus.html')
...
def seebookings(request,new={}):
    ...
    if book_list:
        return render(request, 'reservation/booklist.html', locals())
    else:
...
def signup(request):
    ...
    if request.method == 'POST':
        ...
        if user:
            login(request, user)
            return render(request, 'reservation/thank.html')
        else:
            context["error"] = "Provide valid credentials!"
            return render(request, 'reservation/signup.html', context)
    else:
        return render(request, 'reservation/signup.html', context)
...
def signin(request):
    ...
    if request.method == 'POST':
        ...
        if user:
            ...
            context["error"] = "Provide valid credentials!"
            return render(request, 'reservation/signin.html', context)
    else:
